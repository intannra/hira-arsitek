...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'superfast' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'superfast' ) ) ) );
...
function customizer_library_get_google_font_uri( $fonts ) {
	...
	if ( empty( $family ) ) {
		...
		$request = 'https://fonts.googleapis.com/css?family=' . implode( '%7C', $family );
	}
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'superfast' ),
		'cyrillic'     => __( 'Cyrillic', 'superfast' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'superfast' ),
		'devanagari'   => __( 'Devanagari', 'superfast' ),
		'greek'        => __( 'Greek', 'superfast' ),
		'greek-ext'    => __( 'Greek Extended', 'superfast' ),
		'khmer'        => __( 'Khmer', 'superfast' ),
		'latin'        => __( 'Latin', 'superfast' ),
		'latin-ext'    => __( 'Latin Extended', 'superfast' ),
		'vietnamese'   => __( 'Vietnamese', 'superfast' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'superfast' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'superfast' ),
			'stack' => '"Helvetica Neue",sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'superfast' ),
			'stack' => 'Monaco,"Lucida Sans Typewriter","Lucida Typewriter","Courier New",Courier,monospace'
		),
		'helvetica' => array(
			'label' => _x( 'Helvetica', 'font style', 'superfast' ),
