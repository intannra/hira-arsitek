...
function gmr_library_options_customizer() {
	...
	$options[$gmrprefix . '_chrome_mobile_color'] = array(
		...
		'label'   => __( 'Color In Chrome Mobile', 'superfast' ),
		'section' => $section,
		'type'    => 'color',
		'default' => ''
	);
	...
	$options[$gmrprefix . '_topnav-bgcolor'] = array(
		...
		'label'   => __( 'Background Top Navigation', 'superfast' ),
		'section' => $section,
		'type'    => 'color',
	...
	$options[$gmrprefix . '_topnav-color'] = array(
		...
		'label'   => __( 'Text color - Top Navigation', 'superfast' ),
		'section' => $section,
		'type'    => 'color',
	...
	$options[$gmrprefix . '_hovertopnav-color'] = array(
		...
		'label'   => __( 'Text hover color - Top Navigation', 'superfast' ),
		'section' => $section,
		'type'    => 'color',
	...
	$sections[] = array(
		'id' => $section,
		'title' => __( 'Social & Top Navigation', 'superfast' ),
		'priority' => 40,
		'panel' => $panel_header,
		'description' => __( 'Allow you add social icon and disable top navigation.', 'superfast' )
	);
	
	$options[$gmrprefix . '_active-topnavigation'] = array(
		'id' => $gmrprefix . '_active-topnavigation',
		'label'   => __( 'Disable top navigation', 'superfast' ),
		'section' => $section,
		'type'    => 'checkbox',
		'default' => 0,
	);
	...
	$options[$gmrprefix . '_active-rssicon'] = array(
		...
		'label'   => __( 'Disable RSS icon in social', 'superfast' ),
		'section' => $section,
		'type'    => 'checkbox',
		'default' => 0,
	);
	...
	$options[$gmrprefix . '_fb_url_icon'] = array(
		...
		'label'   => __( 'FB Url', 'superfast' ),
		'section' => $section,
		'type'    => 'url',
		'description' => __( 'Fill using http:// or https://', 'superfast' ),
		'priority' => 90
	);
	
	$options[$gmrprefix . '_twitter_url_icon'] = array(
		'id' => $gmrprefix . '_twitter_url_icon',
		'label'   => __( 'Twitter Url', 'superfast' ),
		'section' => $section,
		'type'    => 'url',
		'description' => __( 'Fill using http:// or https://', 'superfast' ),
		'priority' => 90
	...
	$options[$gmrprefix . '_pinterest_url_icon'] = array(
		...
		'label'   => __( 'Pinterest Url', 'superfast' ),
		'section' => $section,
		'type'    => 'url',
		'description' => __( 'Fill using http:// or https://', 'superfast' ),
		'priority' => 90
	...
	$options[$gmrprefix . '_googleplus_url_icon'] = array(
		...
		'label'   => __( 'Google Plus Url', 'superfast' ),
		'section' => $section,
		'type'    => 'url',
		'description' => __( 'Fill using http:// or https://', 'superfast' ),
		'priority' => 90
	...
	$options[$gmrprefix . '_stumbleupon_url_icon'] = array(
		...
		'label'   => __( 'Stumbleupon Url', 'superfast' ),
		'section' => $section,
		'type'    => 'url',
		'description' => __( 'Fill using http:// or https://', 'superfast' ),
		'priority' => 90
	...
	$options[$gmrprefix . '_wordpress_url_icon'] = array(
		...
		'label'   => __( 'Wordpress Url', 'superfast' ),
		'section' => $section,
		'type'    => 'url',
		'description' => __( 'Fill using http:// or https://', 'superfast' ),
		'priority' => 90
	...
	$options[$gmrprefix . '_instagram_url_icon'] = array(
		...
		'label'   => __( 'Instagram Url', 'superfast' ),
		'section' => $section,
		'type'    => 'url',
		'description' => __( 'Fill using http:// or https://', 'superfast' ),
		'priority' => 90
	...
	$options[$gmrprefix . '_dribbble_url_icon'] = array(
		...
		'label'   => __( 'Dribbble Url', 'superfast' ),
		'section' => $section,
		'type'    => 'url',
		'description' => __( 'Fill using http:// or https://', 'superfast' ),
		'priority' => 90
	...
	$options[$gmrprefix . '_linkedin_url_icon'] = array(
		...
		'label'   => __( 'Linkedin Url', 'superfast' ),
		'section' => $section,
		'type'    => 'url',
		'description' => __( 'Fill using http:// or https://', 'superfast' ),
		'priority' => 90
	...
	$options[$gmrprefix . '_deviantart_url_icon'] = array(
		...
		'label'   => __( 'Deviantart Url', 'superfast' ),
		'section' => $section,
		'type'    => 'url',
		'description' => __( 'Fill using http:// or https://', 'superfast' ),
		'priority' => 90
	...
	$options[$gmrprefix . '_myspace_url_icon'] = array(
		...
		'label'   => __( 'Myspace Url', 'superfast' ),
		'section' => $section,
		'type'    => 'url',
		'description' => __( 'Fill using http:// or https://', 'superfast' ),
		'priority' => 90
	...
	$options[$gmrprefix . '_youtube_url_icon'] = array(
		...
		'label'   => __( 'Youtube Url', 'superfast' ),
		'section' => $section,
		'type'    => 'url',
		'description' => __( 'Fill using http:// or https://', 'superfast' ),
		'priority' => 90
	...
	$options[$gmrprefix . '_picassa_url_icon'] = array(
		...
		'label'   => __( 'Picassa Url', 'superfast' ),
		'section' => $section,
		'type'    => 'url',
		'description' => __( 'Fill using http:// or https://', 'superfast' ),
		'priority' => 90
	...
	$options[$gmrprefix . '_blogger_url_icon'] = array(
		...
		'label'   => __( 'Blogger Url', 'superfast' ),
		'section' => $section,
		'type'    => 'url',
		'description' => __( 'Fill using http:// or https://', 'superfast' ),
		'priority' => 90
	...
	$options[$gmrprefix . '_spotify_url_icon'] = array(
		...
		'label'   => __( 'Spotify Url', 'superfast' ),
		'section' => $section,
		'type'    => 'url',
		'description' => __( 'Fill using http:// or https://', 'superfast' ),
		'priority' => 90
	...
	$options[$gmrprefix . '_delicious_url_icon'] = array(
		...
		'label'   => __( 'Delicious Url', 'superfast' ),
		'section' => $section,
		'type'    => 'url',
		'description' => __( 'Fill using http:// or https://', 'superfast' ),
		'priority' => 90
	...
	$options[$gmrprefix . '_active-metaarchive'] = array(
		'id' => $gmrprefix . '_active-metaarchive',
		'label'   => __( 'Disable meta data in archive', 'superfast' ),
		'section' => $section,
		'type'    => 'checkbox',
		'default' => 0,
	);
	$options[$gmrprefix . '_active-metasingle'] = array(
		...
		'label'   => __( 'Disable meta data in single', 'superfast' ),
		'section' => $section,
		'type'    => 'checkbox',
		'default' => 0,
	);
	$options[$gmrprefix . '_active-postnav'] = array(
		...
		'label'   => __( 'Disable Post Navigation in single', 'superfast' ),
		'section' => $section,
		'type'    => 'checkbox',
		'default' => 0,
	);
	...
	if ( class_exists( 'WooCommerce' ) ) {
		...
		$sections[] = array(
			'id' => $section,
			'title' => __( 'Layout Settings', 'superfast' ),
			'panel' => $panel_woo,
			'priority' => 100
		);
		$sidebar = array(
